...
if (inStock >= 1) {
  console.log(`I'm going to eat more ${food}!`);
} else {
...
var vegetables = ["bok choy", "carrots", "sweet potatoes", "leeks", "mushrooms"];
...
// different fruits.
var fruits = ["blueberries", "canary melons", "bananas", "grapes", "plums", "cherries", "apples"];
...
// You could add days that they're open, hours, number of employees, number of aisles, etc.
